...
- `workflows/subworkflows/deal-finder.json` - Shopping advisor + price tracker with Sheets CRUD + Perplexity + price history charts (45 nodes + 4 sticky notes)
- `workflows/subworkflows/price-checker.json` - Batch price checking engine with history logging (14 nodes + 2 sticky notes)
